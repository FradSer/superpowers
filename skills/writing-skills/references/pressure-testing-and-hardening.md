...
- `bulletproofing-skills.md` - Closing loopholes, rationalization tables, red flags
- `flowcharts-and-examples.md` - When to use flowcharts, code example guidelines
- `deployment-checklist.md` - Complete RED-GREEN-REFACTOR checklist
- `anti-patterns.md` - Common mistakes and what makes a good skill
